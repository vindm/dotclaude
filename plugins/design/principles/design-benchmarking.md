...
- **(Conditional) `voice-north-star.md`** — when the project has a brand voice worth grading (most consumer / B2C projects). Same shape as `design-north-star.md` but for tone / register instead of visual chrome.
